...
Dist_40NN<-read_csv("https://raw.githubusercontent.com/JoonHwang-psu/MatlabEgoNet/refs/heads/main/MatlabEgoNet_HH_Dist_40NN_NoDuplicateRank.csv")
Dist_40NN_HHID<-Dist_40NN[,3:7]
Dist_40NN_wealth<-Dist_40NN[,c(3,5,6,10)]
Dist_40NN_distance<-Dist_40NN[,c(3,6,11)]

Dist_40NN_wide_HHID<-pivot_wider(Dist_40NN_HHID, names_from=NEAR_RANK, values_from=NEAR_FID)
Dist_40NN_wide_wealth<-pivot_wider(Dist_40NN_wealth, names_from=NEAR_RANK, values_from=HH_to_wealth)
Dist_40NN_wide_distance<-pivot_wider(Dist_40NN_distance, names_from=NEAR_RANK, values_from=NEAR_DIST)

n_HH<-nrow(Dist_40NN_wide_HHID)

Dist_40NN_wide_wealth$wealth_gini<-0
Dist_40NN_wide_distance$distance_mean<-0

hist(log(as.numeric(Dist_40NN_wide_wealth[1,3:32]), base=10))
hist(log(as.numeric(t(Dist_40NN_wide_wealth[,2])), base=10))

for (i in 1:n_HH){
  Dist_40NN_wide_wealth$wealth_gini[i]<-ineq(as.numeric(Dist_40NN_wide_wealth[i,2:42]), type= "Gini", na.rm=TRUE)
  Dist_40NN_wide_distance$distance_mean[i]<-mean(as.numeric(Dist_40NN_wide_distance[i,2:42]), na.rm=TRUE)
}

write.csv(Dist_40NN_wide_HHID, file="MatlabEgoNet_40NN_HHID.csv")
write.csv(Dist_40NN_wide_wealth, file="MatlabEgoNet_40NN_wealth.csv")
write.csv(Dist_40NN_wide_distance, file="MatlabEgoNet_40NN_distance.csv")

summary(Dist_40NN_wide_wealth$wealth_gini)
hist(Dist_40NN_wide_wealth$wealth_gini)
summary(Dist_40NN_wide_distance$distance_mean)
hist(Dist_40NN_wide_distance$distance_mean)

context_40NN<-merge(Dist_40NN_wide_HHID, Dist_40NN_wide_distance[,c(1,42)], by="HH_from")
context_40NN<-merge(context_40NN, Dist_40NN_wide_wealth[,c(1,43)], by="HH_from")

write.csv(context_40NN, file = "MatlabEgoNet_40NN_context.csv", row.names = TRUE)
...
colnames(context_40NN)[1]<-c("HHID")
colnames(EgoNet_total)[1]<-c("HHID")

EgoNet_total_context <- merge(EgoNet_total, context_40NN[,c(1,44,45)], by="HHID")
...
quantile(EgoNet_total_context$wealth_gini, probs = c(0.10, 0.90), na.rm = TRUE) # 10% = 0.2622561 , 90% = 0.3315532  
...
write.csv(formatted_table, "Netsize_40NN.csv", row.names = FALSE)
...
formatted_table[is.na(formatted_table)] <- ""
print(formatted_table)
write.csv(formatted_table, "3wayNetsize_40NN.csv", row.names = FALSE)
...
formatted_table[is.na(formatted_table)] <- ""
print(formatted_table)
write.csv(formatted_table, "Reciprocity_40NN.csv", row.names = FALSE)
...
formatted_table[is.na(formatted_table)] <- ""
print(formatted_table)
write.csv(formatted_table, "3wayReciprocity_40NN.csv", row.names = FALSE)
...
formatted_table[is.na(formatted_table)] <- ""
print(formatted_table)
write.csv(formatted_table, "LongDist_40NN.csv", row.names = FALSE)
...
formatted_table[is.na(formatted_table)] <- ""
print(formatted_table)
write.csv(formatted_table, "3wayLongDist_40NN.csv", row.names = FALSE)
...
formatted_table[is.na(formatted_table)] <- ""
print(formatted_table)
write.csv(formatted_table, "Local_40NN.csv", row.names = FALSE)
...
formatted_table[is.na(formatted_table)] <- ""
print(formatted_table)
write.csv(formatted_table, "3wayLocal_40NN.csv", row.names = FALSE)
...
formatted_table[is.na(formatted_table)] <- ""
print(formatted_table)
write.csv(formatted_table, "SuppIn_40NN.csv", row.names = FALSE)
...
formatted_table[is.na(formatted_table)] <- ""
print(formatted_table)
write.csv(formatted_table, "3waySuppIn_40NN.csv", row.names = FALSE)
...
formatted_table[is.na(formatted_table)] <- ""
print(formatted_table)
write.csv(formatted_table, "SuppOut_40NN.csv", row.names = FALSE)
...
formatted_table[is.na(formatted_table)] <- ""
print(formatted_table)
write.csv(formatted_table, "3waySuppOut_40NN.csv", row.names = FALSE)
...
formatted_table[is.na(formatted_table)] <- ""
print(formatted_table)
write.csv(formatted_table, "MainEffectModels_40NN.csv", row.names = FALSE)
